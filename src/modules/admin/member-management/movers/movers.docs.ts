  ...
  endpoints: {
    "GET /": {
      ...
      description: [
        ...
        "- `sorts`: 반복 query로 전달하는 정렬 기준. `CREATED_AT_DESC` | `CREATED_AT_ASC` | `PENDING_DESC` | `PENDING_ASC` | `CONFIRMED_DESC` | `CONFIRMED_ASC` | `RATING_DESC` | `RATING_ASC` | `CAREER_DESC` | `CAREER_ASC`",
      ].join("\n"),
      responses: { 200: "조회 성공" },
    },
    "GET /{id}": {
