  ...
  endpoints: {
    "GET /": {
      ...
      description: [
        ...
        "- `targetType`: CUSTOMER | MOVER | REVIEW | RESIDENCE_REVIEW | GIVEAWAY",
        "- `reason`: 신고 사유 필터",
    ...
    "GET /:reportId": {
      ...
      description: [
        ...
        "- 대상 유형에 따라 CUSTOMER, MOVER, REVIEW, RESIDENCE_REVIEW, GIVEAWAY 정보를 반환합니다.",
        "- CUSTOMER/MOVER는 사용자 기본 정보와 활성 상태를 반환합니다.",
        "- REVIEW/RESIDENCE_REVIEW/GIVEAWAY는 원본 콘텐츠 정보를 함께 반환합니다.",
