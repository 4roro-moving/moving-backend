  ...
  endpoints: {
    "POST /": {
      ...
      description: [
        ...
        "- 정지 계정의 이의 제기 전용 토큰으로 요청하면, 전달한 `category`와 무관하게 `SUSPENSION_APPEAL` 분류로 생성됩니다.",
      ].join("\n"),
      responses: { 201: "생성 성공" },
    },
    "GET /": {
      summary: "내 문의 목록",
      description:
        "최근 대화순으로 조회됩니다. `status` 로 필터할 수 있습니다. 정지 계정의 이의 제기 전용 토큰도 기존 본인 문의를 읽기 전용으로 조회할 수 있습니다.",
      responses: { 200: "조회 성공" },
    },
    "GET /:inquiryId": {
      summary: "내 문의 상세",
      description:
        "메시지 스레드를 포함합니다. 조회 시 상대방 메시지가 읽음 처리됩니다. 정지 계정의 이의 제기 전용 토큰은 본인 문의를 읽기 전용으로 조회할 수 있습니다.",
      responses: { 200: "조회 성공", 404: "문의를 찾을 수 없습니다." },
    },
    "POST /:inquiryId/messages": {
      summary: "메시지 추가",
      description:
        "열린 문의에만 가능하며, 추가 시 상태가 `OPEN` 이 됩니다. 종료된 문의는 불가합니다. 정지 계정의 이의 제기 전용 토큰은 본인의 `SUSPENSION_APPEAL` 문의에만 메시지를 추가할 수 있습니다.",
      responses: {
        201: "추가 성공",
        404: "문의를 찾을 수 없습니다.",
        409: "이미 종료된 문의입니다.",
    ...
    "PATCH /:inquiryId/close": {
      summary: "문의 종료",
      description: "정지 계정의 이의 제기 전용 토큰은 문의를 종료할 수 없습니다.",
      responses: {
        200: "종료 성공",
        404: "문의를 찾을 수 없습니다.",
        409: "이미 종료된 문의입니다.",
